...
function changeBackgroundColor() {
    ...
    'event_category': 'Color Change', // Category of the event
    'event_label': 'Background Color Changed', // Label for the event
    ...
    'event_callback': function() {
        ...
        console.log('basic_button_click event tracked successfully.');
    },
